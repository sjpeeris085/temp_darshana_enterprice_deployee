var MailGenerator = function (loginId, name, code, state) {
  let title = "";
  let button = "";
  ...
  switch (state) {
    case "reset-psw":
      button = "";
      title = `Your password reset code: ${loginId} <a href='${code}'>Reset password Now</a>`;
      break;
    case "update-psw-success":
      button = "";
      title = `Your have update your password on: ${code}`;
      break;
    case "e-verify":
