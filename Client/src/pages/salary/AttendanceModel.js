...
const AttendanceModel = ({ open, setOpen, employee, attendance, alertRef, year, month }) => {
    ...
    return (
        ...
        >
            <DialogTitle id="alert-dialog-title" style={{ fontWeight: 'bold', fontSize: '13pt' }}>
                Timestamps of {`${employee?.full_name} (ID: ${employee?.emp_id} | ${year}-${month})`}
            </DialogTitle>
            <DialogContent>
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="left" style={{ color: row.is_present ? 'green' : 'tomato' }}>
                                                        <Typography>{row.is_present ? 'Present' : 'Absent'}</Typography>
                                                    </TableCell>
