...
const EmployeeTable = ({ handleTimesClick, hasAttendance, selectEmployee }) => {
                            ...
                            {stableSort(rows, getComparator(order, orderBy)).map((row, index) => {
                                ...
                                return (
                                    <TableRow
                                        ...
                                        onClick={() => selectEmployee(row._id)}
                                    >
                                        ...
                                        <TableCell align="right">
                                            {hasAttendance || row.isAttendanceSaved ? (
                                                <IconButton
                                                    disabled={!row.isAttendanceSaved}
                                                    size="large"
                                                    color="secondary"
                                                    onClick={() => handleTimesClick(row._id)}
                                                >
                                                    <FieldTimeOutlined
                                                        style={{
